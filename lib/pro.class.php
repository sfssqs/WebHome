...
class pro extends base{
	...
	public $table_co='pro_co';		            //本系统的内容表
	public $table_lm='pro_lm';		            //本系统的分类表
	public $sy_id=7;                            //本系统的seo信息的记录id(同时也是多图、相关信息、相关文件、相关视频的系统区分id，因为整站的多图、相关信息、相关文件、相关视频都是只保存在4个表中)
