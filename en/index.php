...
<div class="pro" id="show">
  <div class="pro_t"><span><a href="product.php"><img src="images/index01_03.png"/></a></span> <font>product show</font> &nbsp;&nbsp;<em>PRODUCTS</em>
    <div class="clear"></div>
  </div>
  <ul class="pro_ul">
    <?php
    ...
    <li   <?php if($a%3==0) echo 'class="last"'?>>
      ...
      <span><?php echo $v['title_en']?></span> <font>Product model： <?php echo $v['pro_can1']?></font>
      <p><?php echo getstr($v['f_body_en'],80)?><a href="product_show.php?id=<?php echo $v['id']?>">More</a></p>
    </li>
    <?php $a++;}?>
    <div class="clear"></div>
  </ul>
