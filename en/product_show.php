...
<div class="detail">
  ...
  <div class="detail_r fr"> <span style="font-family: 微软雅黑;font-size: 20px;"><?php $pro->showxx_zd('title_en');?></span> <font style="font-family: 宋体;font-size: 16px;">Product model： <?php $pro->showxx_zd('pro_can1');?></font>
    <p style="font-family: 宋体; font-size: 14px;"><?php $pro->showxx_zd('f_body_en');?></p>
  </div>
  <div class="clear"></div>
</div>
<div class="detail_t">
  <div class="detail_tt">Product details</div>
  <?php $pro->showxx_zd('z_body_en');?>
</div>
