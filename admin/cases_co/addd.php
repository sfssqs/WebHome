...
$sql='insert into `'.$conf['sy']['table_co'].'` (`lm`,`list_lm`,`title`,`keyword`,`link_url`,`f_body`,`z_body`,`img_sl`,`pic_sl`,`fil_sl`,`vid_sl`,`ym_tit`,`ym_key`,`ym_des`,`title_en`,`f_body_en`,`z_body_en`,`ym_tit_en`,`ym_key_en`,`ym_des_en`,`ding`,`tuijian`,`hot`,`pass`,`read_num`,`px`,`ip`,`wtime`) values('.$lm.',"'.$list_lm.'","'.$title.'","'.$keyword.'","'.$link_url.'","'.$f_body.'","'.$z_body.'","'.$img_sl.'","'.$pic_sl.'","'.$fil_sl.'","'.$vid_sl.'","'.$ym_tit.'","'.$ym_key.'","'.$ym_des.'","'.$title_en.'","'.$f_body_en.'","'.$z_body_en.'","'.$ym_tit_en.'","'.$ym_key_en.'","'.$ym_des_en.'",0,0,0,1,0,'.$px.',"'.getip().'",'.time().')';
$db->execute($sql);
$id=$db->insert_id();
