...
$sql='update `'.$conf['sy']['table_co'].'` set `lm`='.$lm.',`list_lm`="'.$list_lm.'",`title`="'.$title.'",`keyword`="'.$keyword.'",`link_url`="'.$link_url.'",`f_body`="'.$f_body.'",`z_body`="'.$z_body.'",`img_sl`="'.$img_sl.'",`ym_tit`="'.$ym_tit.'",`ym_key`="'.$ym_key.'",`ym_des`="'.$ym_des.'",`title_en`="'.$title_en.'",`f_body_en`="'.$f_body_en.'",`z_body_en`="'.$z_body_en.'",`ym_tit_en`="'.$ym_tit_en.'",`ym_key_en`="'.$ym_key_en.'",`ym_des_en`="'.$ym_des_en.'",`px`='.$px.' where `id`='.$id.'';
$db->execute($sql);
