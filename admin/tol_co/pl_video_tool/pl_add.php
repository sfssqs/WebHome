...
//获取哪条信息id需要相关视频，添加视频时是没有id系统自动生成一个临时id用session来保存，等视频添加后，再用视频的记录id来替换session保存的临时id
  ...
  <tr class="tdbg"> 
    ...
    <td >
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td><iframe name="frame2" id="frame2" src="up_video_tool/up.php?frameid=frame2&kuang=vid_sl" style="margin-top:2px; width:auto;width:380px; height:22px; overflow:hidden;" frameborder="0"  scrolling="no"></iframe>
					<?php
                    if(isset($s_txt)&&$s_txt!=''){
                    ?>
                        <br />
