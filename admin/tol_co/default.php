...
<?php
$sql='select a.`id`,a.`lm`,a.`title`,a.`ding`,a.`tuijian`,a.`hot`,a.`pass`,a.`read_num`,a.`px`,b.`title_lm`,b.`add_xx` from `'.$conf['sy']['table_co'].'` a left join `'.$conf['sy']['table_lm'].'` b on a.`lm`=b.`id_lm` where 1=1 '.$sq.' order by  a.`ding` desc,a.`px` desc,a.`id` desc';
...
<p class="p">
<a href="javascript:CheckAll('form1');">全选</a>/<a href="javascript:CheckOthers('form1');">反选</a>&nbsp;<input name="" type="submit"  class="btn" value="排序" />
</p>
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
  <tr class="tdbg3">
    <td align="center">
