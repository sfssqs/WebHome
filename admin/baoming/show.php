...
?>
  ...
  <tr class="tdbg">
    ...
    <TR class="tdbg2" >
      <TD width="27%" align="right" class="tdbg2" >留言内容：</TD>
      <TD width="73%" align="left" valign="top" class="tdbg2"><?php echo $row['z_body']?></TD>
    </TR>
    <?php
    if ($row['htime']!=''){
	?>
    <tr class="tdbg">
      <td height="20" align="right">处理时间：</td>
      <td><input name="htime" type="text" id="htime" value="<?php echo date('Y-m-d H:i:s',$row['htime'])?>" maxlength="50"></td>
    </tr>
    <?php
    }
	?>
    <TR >
      <TD width="27%" height="50" align="right" valign="top" class="tdbg2">处理备注：</TD>
      <TD width="73%" align="left" valign="top" class="tdbg2"><textarea name="h_body" cols="60" rows="6"><?php echo rehtml($row['h_body'])?></textarea>
        <br>
      </TD>
    </TR>
