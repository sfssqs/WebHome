...
$conf['sy']=array(
	'name'=>'产品',                     //系统名称
	'table_lm'=>$tablepre.'pro_lm',    //分类表名
	'table_co'=>$tablepre.'pro_co',    //信息表名
	'folder_lm'=>'pro_lm',             //分类文件夹名
	'folder_co'=>'pro_co',             //信息文件夹名
...
$conf['co']=array(
	...
	'pro_can'=>true,                    //产品参数
	'f_body'=>true,                     //简要介绍
	't_body'=>false,                    //产品特性(名称不一定是产品特性，具体看你的网站这个编辑器放什么内容)
	'g_body'=>false,                    //产品规格(名称不一定是产品规格，具体看你的网站这个编辑器放什么内容)
	'img_sl'=>true,                     //图片上传
	'pic_sl'=>false,                    //图片2上传
	'fil_sl'=>false,                    //文件上传
	'vid_sl'=>false,                    //视频上传
