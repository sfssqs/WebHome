...
$sql='update `'.$conf['sy']['table_co'].'` set `lm`='.$lm.',`list_lm`="'.$list_lm.'",`title`="'.$title.'",`title_en`="'.$title_en.'",`color_font`="'.$color_font.'",`keyword`="'.$keyword.'",`link_url`="'.$link_url.'",`info_from`="'.$info_from.'",`info_author`="'.$info_author.'",`f_body`="'.$f_body.'",`z_body`="'.$z_body.'",`f_body_en`="'.$f_body_en.'",`z_body_en`="'.$z_body_en.'",`img_sl`="'.$img_sl.'",`pic_sl`="'.$pic_sl.'",`fil_sl`="'.$fil_sl.'",`vid_sl`="'.$vid_sl.'",`ym_tit`="'.$ym_tit.'",`ym_key`="'.$ym_key.'",`ym_des`="'.$ym_des.'",`px`='.$px.',`wtime`="'.$wtime.'" where `id`='.$id.'';
$db->execute($sql);
