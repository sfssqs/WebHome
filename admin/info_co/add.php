...
<table width="100%" border="0" cellpadding="2" cellspacing="1"  class="border_tab">
  ...
  <tr  class="tdbg" id="dis_uselink" style="display:none;" >
    ...
    <td><input name="link_url" type="text" id="link_url" size="57" maxlength="250" value="">
    </td>
  </tr>
  ...
  <tr class="tdbg" id="dis_z_body"  style="display:none;">
  ...
  <tr class="tdbg" id="dis_img_sl" style="display:none;">          
    ...
    <td >
    <iframe name="frame1" id="frame1" src="up_info_tool/up.php?frameid=frame1&kuang=img_sl" style="margin-top:2px; width:auto; width:380px; height:22px; overflow:hidden;" frameborder="0"  scrolling="no"></iframe>  			    
    <input type="hidden" name="img_sl" id="img_sl">
    <br />
    <span id="img_sl_txt" class="red"></span>
    </td>
  </tr>
  <tr class="tdbg" id="dis_pic_sl" style="display:none;">          
    <td width="120" align="right">图片2上传：</td>          
    <td >
    <iframe name="frame4" id="frame4" src="up_info_tool/up.php?frameid=frame4&kuang=pic_sl" style="margin-top:2px; width:auto; width:380px; height:22px; overflow:hidden;" frameborder="0"  scrolling="no"></iframe>  			    
    <input type="hidden" name="pic_sl" id="pic_sl">
    <br />
    <span id="pic_sl_txt" class="red"></span>
    </td>
  </tr>
  <?php
