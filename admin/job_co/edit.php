...
<tr class="tdbg">
    ...
    <td><INPUT name="title" type="text" id="title"  value="<?php echo $row['title']?>" size="35" maxlength="80"> <span class="red">*</span></td>
  </tr>
  <?php
  if ($conf['co']['num']==true){
  ?>
  <tr class="tdbg">
    ...
    <td><INPUT name="num" type="text" id="num"  maxlength="50" size="35" value="<?php echo $row['num']?>"></td>
  </tr>
  <?php
  }
  ?>
  ...
  <tr class="tdbg">
    ...
    <td><input name="address" type="text" id="address"  maxlength="50" size="35" value="<?php echo $row['address']?>" /></td>
  </tr>
  <?php
  }
  ?>
  ...
  ?>
    <tr class="tdbg">
      <td width="120" align="right">发布日期：</td>
        <td ><input name="stime" type="text" id="stime" value="<?php echo $row['stime']?>" maxlength="50"></td>          
    </tr>
  <?php
  }
  ?>
  ...
  ?>
    <tr class="tdbg">
      <td width="120" align="right">结束日期：</td>
        <td ><input name="etime" type="text" id="etime" value="<?php echo $row['etime']?>" maxlength="50" /></td>          
    </tr>
  <?php
  }
  ?>
  ...
  <tr class="tdbg">
    ...
    <td>
    <textarea id="f_body" name="f_body" style="width:670px;height:200px;display:none;"><?php echo $row['f_body']?></textarea>
    </td>
  </tr>
  <?php
  }
  ...
  <tr class="tdbg">
    ...
    <td>
    <textarea id="z_body" name="z_body" style="width:670px;height:200px;display:none;"><?php echo $row['z_body']?></textarea>
    </td>
  </tr>
  <?php
  }
