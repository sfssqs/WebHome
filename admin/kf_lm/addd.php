...
//添加分类信息
$sql='insert into `'.$conf['sy']['table_lm'].'` (`fid`,`title_lm`,`add_xx`,`add_xia`,`con_att`,`tuijian`,`hot`,`pass`,`px`,`wtime`,`ip`) values('.$fid.',"'.$title_lm.'","'.$add_xx.'","'.$add_xia.'","'.$con_att.'",0,0,1,'.$px.','.time().',"'.getip().'")';
$db->execute($sql);
