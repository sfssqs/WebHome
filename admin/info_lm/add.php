...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border_tab">
  ...
  <tr class="tdbg">
    ...
    <td><INPUT name="title_lm_en" type="text" id="title_lm_en" size="30" maxlength="150"> <span class="red">*</span></td>
  </tr>
  <?php }?>
  <?php
  ...
  <tr class="tdbg">
    <td align="right" valign="top"><br />
      简要介绍：</td>
    <td ><textarea name="f_body_lm" rows="4" id="f_body_lm" style="width:450px;"></textarea></td>
  </tr>
  <?php
  }
  ?>
  ...
  <tr class="tdbg">
    ...
    <td>
    <textarea id="z_body_lm" name="z_body_lm" style="width:670px;height:300px;display:none;"></textarea>
    </td>
  </tr>
  ...
  <tr class="tdbg"  id="gaoji" style="display:none;">
    ...
    <tr>
      ...
      <tr>
        <td height="30">
          <input name="info_img_sl" type="radio" class="radio"  value="yes"  onclick="document.getElementById('tr_s').style.display=''">
          是
          <input name="info_img_sl" type="radio" class="radio"  value="no"  checked onclick="document.getElementById('tr_s').style.display='none'">
        否 有图片上传</td>
      </tr>
      <tr id="tr_s" style="display:none;">
        ...
        图片上传提示尺寸：<input name="info_img_txt" id="info_img_txt" type="text" style="width:180px;" /><br />
          <input type="radio"  class="radio" name="info_img_pic"  value="yes" onclick="document.getElementById('tb_s').style.display=''">
          是
          <input name="info_img_pic" class="radio" type="radio"  value="no" checked  onclick="document.getElementById('tb_s').style.display='none'">
        否 生成缩略图
        <table border="0" cellspacing="0" cellpadding="2" id="tb_s" style="display:none;">
          ...
          <td>类型</td>
            ...
            <td>宽度</td>
            <td><input type="text" size="8" name="info_img_wid" /></td>
            <td>高度</td>
            <td><input type="text" size="8" name="info_img_hei" /></td>
          </tr>
        </table>
        </td>
      </tr>
      <tr>
        <td height="30">
          <input name="info_pic_sl" type="radio" class="radio"  value="yes"  onclick="document.getElementById('tr_d').style.display=''">
          是
          <input name="info_pic_sl" type="radio" class="radio"  value="no"  checked onclick="document.getElementById('tr_d').style.display='none'">
        否 有图片2上传</td>
      </tr>
      <tr id="tr_d" style="display:none;">
        ...
        图片2上传提示尺寸：
          ...
          <input type="radio"  class="radio" name="info_pic_pic" value="yes" onclick="document.getElementById('tb_d').style.display=''">
          是
          <input name="info_pic_pic" class="radio" type="radio"  value="no" checked  onclick="document.getElementById('tb_d').style.display='none'">
        否 生成缩略图
        <table border="0" cellspacing="0" cellpadding="2" id="tb_d" style="display:none;">
          <tr>
          <td>类型</td>
            <td>
            ...
            <td>宽度</td>
            <td><input type="text" size="8" name="info_pic_wid" /></td>
            <td>高度</td>
            <td><input type="text" size="8" name="info_pic_hei" /></td>
          </tr>
        </table>
        </td>
      </tr>
