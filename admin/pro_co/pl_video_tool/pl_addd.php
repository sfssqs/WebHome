...
$sql='insert into `'.$pl_table.'` (`sy_id`,`pl_id`,`title`,`link_url`,`z_body`,`img_sl`,`vid_sl`,`ym_tit`,`ym_key`,`ym_des`,`read_num`,`px`,`ip`,`wtime`) values('.$pl_sy_id.','.$pr_id.',"'.$title.'","'.$link_url.'","'.$z_body.'","'.$img_sl.'","'.$vid_sl.'","'.$ym_tit.'","'.$ym_key.'","'.$ym_des.'",0,'.$px.',"'.getip().'",'.time().')';
$db->execute($sql);

msg('添加成功','parent.document.getElementById("fra_video").src="pl_video_tool/pl_default.php?pl_id='.$pr_id.'";parent.tanchuCancle()');
?>