...
$sql='insert into `'.$pl_table.'` (`sy_id`,`pl_id`,`title`,`link_url`,`z_body`,`img_sl`,`ym_tit`,`ym_key`,`ym_des`,`read_num`,`px`,`ip`,`wtime`) values('.$pl_sy_id.','.$pr_id.',"'.$title.'","'.$link_url.'","'.$z_body.'","'.$img_sl.'","'.$ym_tit.'","'.$ym_key.'","'.$ym_des.'",0,'.$px.',"'.getip().'",'.time().')';
$db->execute($sql);
