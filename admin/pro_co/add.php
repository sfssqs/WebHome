...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border_tab">
  ...
  ?>
  <?php
  if ($conf['co']['pro_can']==true){
  ?>
    <tr class="tdbg2">
        <td width="120" align="right">产品型号：</td>
        <td>
        <table border="0" cellspacing="0" cellpadding="2">
      <tr>
       <!-- <td>产地：</td>-->
        <td><INPUT name="pro_can1" type="text" id="pro_can1"  maxlength="250"></td>
        <!--<td>规格：</td>
  ...
  ?>
  <tr class="tdbg">
    <td width="120" align="right">英文详细介绍：</td>
    <td>
    <textarea id="z_body_en" name="z_body_en" style="width:670px;height:300px;display:none;"></textarea>    </td>
  </tr>
  <?php
  }
  ?> 
  ...
  ?>
  <tr class="tdbg">
    <td width="120" align="right">产品特性：</td>
    <td>
    <textarea id="t_body" name="t_body" style="width:670px;height:300px;display:none;"></textarea>
    </td>
  </tr>
  <?php
  if ($conf['co']['en']==true){
  ?>
  <tr class="tdbg">
    <td width="120" align="right">英文产品规格：</td>
    <td>
    <textarea id="t_body_en" name="t_body_en" style="width:670px;height:300px;display:none;"></textarea>
    </td>
  </tr>
  <?php
  }
  ...
  <tr class="tdbg">
    ...
    <td>
    <textarea id="g_body" name="g_body" style="width:670px;height:300px;display:none;"></textarea>
    </td>
  </tr>
  <?php
  if ($conf['co']['en']==true){
  ?>
  <tr class="tdbg">
    <td width="120" align="right">英文产品参数：</td>
    <td>
    <textarea id="g_body_en" name="g_body_en" style="width:670px;height:300px;display:none;"></textarea>
    </td>
  </tr>
  <?php
  }
  ...
  <script>
        ...
        KindEditor.ready(function(K) {
		  ...
		  if ($conf['co']['t_body']==true){
		  ?>
			K.create('textarea[name="t_body"]',options);
			K.create('textarea[name="t_body_en"]',options);
		  <?php
		  }
		  ?>
		  <?php
		  if ($conf['co']['g_body']==true){
		  ?>	
			K.create('textarea[name="g_body"]',options);
			K.create('textarea[name="g_body_en"]',options);
		  <?php
		  }
		  ?>
        });
  ...
  <tr class="tdbg">
    ...
    <td >
	<iframe id="fra_duotu" name="fra_duotu" src="pl_image_tool/pl_default.php" style="width:670px; height:285px;" frameborder="0" scrolling="auto"></iframe>
    </td>
  </tr>
  <?php
  }
  ...
  <tr class="tdbg">
    ...
    <td >
	<iframe id="fra_info" name="fra_info" src="pl_info_tool/pl_default.php" style="width:670px; height:285px;" frameborder="0" scrolling="auto"></iframe>
    </td>
  </tr>
  <?php
  }
  ...
  <tr class="tdbg">
    ...
    <td >
	<iframe id="fra_file" name="fra_file" src="pl_file_tool/pl_default.php" style="width:670px; height:285px;" frameborder="0" scrolling="auto"></iframe>
    </td>
  </tr>
  <?php
  }
  ...
  <tr class="tdbg">
    ...
    <td >
	<iframe id="fra_video" name="fra_video" src="pl_video_tool/pl_default.php" style="width:670px; height:285px;" frameborder="0" scrolling="auto"></iframe>
    </td>
  </tr>
  <?php
  }
...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border_tab">
  ...
  ?>
  <tr class="tdbg">
    <td width="120" height="22" align="right">英文页面标题：</td>
    <td>
    <textarea name="ym_tit_en" cols="80" rows="3"></textarea><br />
	建议填写不超过80个字，不要使用“回车键”换行
    </td>
  </tr>
  <?php }?>
  ...
  ?>
  <tr class="tdbg">
    <td width="120" height="22" align="right" >英文页面关键字：</td>
    <td >
    <textarea name="ym_key_en" cols="80" rows="3"></textarea><br />
	建议填写不超过100个字，不要使用“回车键”换行
    </td>
  </tr>
  <?php }?>
