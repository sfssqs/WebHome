...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border_tab">
  ...
  ?>
    <tr class="tdbg2">
      ...
      <tr>
        <!--<td>产地：</td>-->
        <td><INPUT name="pro_can1" type="text" id="pro_can1"  maxlength="250" value="<?php echo $row['pro_can1']?>"></td>
        <!--<td>规格：</td>
        <td><INPUT name="pro_can2" type="text" id="pro_can2"  maxlength="50" value="<?php echo $row['pro_can2']?>"></td>-->
      </tr>
      <!--<tr>
        <td>颜色：</td>
        <td><INPUT name="pro_can3" type="text" id="pro_can3"  maxlength="50" value="<?php echo $row['pro_can3']?>"></td>
        <td>售价：</td>
        <td><INPUT name="pro_can4" type="text" id="pro_can4"  maxlength="50" value="<?php echo $row['pro_can4']?>"></td>
      </tr>-->
    </table>
    </td>
  </tr>
  ...
  <tr class="tdbg">
    ...
    <td>
    <textarea id="t_body" name="t_body" style="width:670px;height:300px;display:none;"><?php echo $row['t_body']?></textarea>
    </td>
  </tr>
  ...
  ?>
  <tr class="tdbg">
    <td width="120" align="right">英文产品特性：</td>
    <td>
    <textarea id="t_body_en" name="t_body_en" style="width:670px;height:300px;display:none;"><?php echo $row['t_body_en']?></textarea>
    </td>
  </tr>
  <?php
  }
  ...
  <tr class="tdbg">
    ...
    <td>
    <textarea id="g_body" name="g_body" style="width:670px;height:300px;display:none;"><?php echo $row['g_body']?></textarea>
    </td>
  </tr>
  ...
  <tr class="tdbg">
    ...
    <td>
    <textarea id="g_body_en" name="g_body_en" style="width:670px;height:300px;display:none;"><?php echo $row['g_body_en']?></textarea>
    </td>
  </tr>
  <?php
  }
...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border_tab">
  ...
  <tr class="tdbg">
    ...
    <td>
    <textarea name="ym_tit_en" cols="80" rows="3"><?php echo rehtml($row['ym_tit_en'])?></textarea><br />
	建议填写不超过80个字，不要使用“回车键”换行
    </td>
  </tr>
  <?php }?>
  ...
  <tr class="tdbg">
    ...
    <td >
    <textarea name="ym_key_en" cols="80" rows="3"><?php echo rehtml($row['ym_key_en'])?></textarea><br />
	建议填写不超过100个字，不要使用“回车键”换行
    </td>
  </tr>
  <?php }?>
  ...
  ?>
  <tr class="tdbg">
    <td width="120" height="22" align="right" class="tdbg">英文页面描述：</td>
    <td><textarea name="ym_des_en" cols="80" rows="3"><?php echo rehtml($row['ym_des_en'])?></textarea><br />
    建议填写不超过200个字，不要使用“回车键”换行
    </td>
  </tr>
  <?php }?>
