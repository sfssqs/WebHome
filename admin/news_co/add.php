...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border_tab">
  ...
  <tr class="tdbg">
    ...
    <td>
    <textarea id="z_body" name="z_body" style="width:670px;height:300px;display:none;"></textarea>    </td>
  </tr>
  <?php
  if ($conf['co']['en']==true){
  ?>
  ...
  <tr class="tdbg">
    ...
    <td >
	<iframe id="fra_duotu" name="fra_duotu" src="pl_image_tool/pl_default.php" style="width:670px; height:285px;" frameborder="0" scrolling="auto"></iframe>    </td>
  </tr>
  <?php
  }
  ?>
