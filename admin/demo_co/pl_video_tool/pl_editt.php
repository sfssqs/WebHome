...
$sql='update '.$pl_table.' set `title`="'.$title.'",`link_url`="'.$link_url.'",`z_body`="'.$z_body.'",`img_sl`="'.$img_sl.'",`vid_sl`="'.$vid_sl.'",`ym_tit`="'.$ym_tit.'",`ym_key`="'.$ym_key.'",`ym_des`="'.$ym_des.'",`px`='.$px.' where id='.$id.'';
$db->execute($sql);
