...
$sql='insert into `'.$conf['sy']['table_co'].'` (`lm`,`list_lm`,`title`,`keyword`,`link_url`,`f_body`,`z_body`,`img_sl`,`pic_sl`,`fil_sl`,`vid_sl`,`ym_tit`,`ym_key`,`ym_des`,`ding`,`tuijian`,`hot`,`pass`,`read_num`,`px`,`ip`,`wtime`) values('.$lm.',"'.$list_lm.'","'.$title.'","'.$keyword.'","'.$link_url.'","'.$f_body.'","'.$z_body.'","'.$img_sl.'","'.$pic_sl.'","'.$fil_sl.'","'.$vid_sl.'","'.$ym_tit.'","'.$ym_key.'","'.$ym_des.'",0,0,0,1,0,'.$px.',"'.getip().'",'.$wtime.')';
$db->execute($sql);
$id=$db->insert_id();
